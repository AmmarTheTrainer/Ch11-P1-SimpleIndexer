...
namespace Ch11_P1_SimpleIndexer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            WorkingWithStudentExamle();
            Console.ReadLine();
        }
        private static void WorkingWithStudentExamle()
        {
            Console.WriteLine(" \n ******** Student Example ********  \n");
            LectureHall studentsInHall = new LectureHall();

            //studentsInHall[0] = new Student(37, "Sadam");
            //studentsInHall[1] = new Student(23, "faiza");

            //studentsInHall["Parathe35"] = new Student(24, "XYZ");

            Console.WriteLine();

            foreach (Student student in studentsInHall)
            {
